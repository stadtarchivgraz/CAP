...
class BracketSpace_Notification_Dependencies_HTMLPurifier_Strategy_FixNesting extends BracketSpace_Notification_Dependencies_HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = BracketSpace_Notification_Dependencies_HTMLPurifier_Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            while (isset($node->children[$ix])) {
                ...
                if ($child instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Node_Element) {
                    $go = true;
        ...
        return BracketSpace_Notification_Dependencies_HTMLPurifier_Arborize::flatten($node, $config, $context);
    }
}
