 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_Injector_SafeObject extends BracketSpace_Notification_Dependencies_HTMLPurifier_Injector
{
    /**
     * @type string
     */
    ...
    public function handleElement(&$token)
    {
        if ($token->name == 'object') {
            ...
            foreach ($this->addParam as $name => $value) {
                $new[] = new BracketSpace_Notification_Dependencies_HTMLPurifier_Token_Empty('param', array('name' => $name, 'value' => $value));
            }
            $token = $new;
