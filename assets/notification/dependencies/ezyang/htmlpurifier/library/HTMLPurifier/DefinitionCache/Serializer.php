...
class BracketSpace_Notification_Dependencies_HTMLPurifier_DefinitionCache_Serializer extends BracketSpace_Notification_Dependencies_HTMLPurifier_DefinitionCache
{
    ...
    /**
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_Config $config
     * @return bool|BracketSpace_Notification_Dependencies_HTMLPurifier_Config
     */
    ...
    public function generateBaseDirectoryPath($config)
    {
        ...
        $base = is_null($base) ? HTMLPURIFIER_PREFIX . '/BracketSpace_Notification_Dependencies_HTMLPurifier/DefinitionCache/Serializer' : $base;
        return $base;
    }
