 ...
 * are best described BracketSpace_Notification_Dependencies_HTMLPurifier_Strategy_MakeWellFormed->processToken()
 * documentation.
 *
 ...
 */
abstract class BracketSpace_Notification_Dependencies_HTMLPurifier_Injector
{
     ...
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_Token $current Current token variable.
    ...
    protected function forwardUntilEndToken(&$i, &$current, &$nesting)
    {
        ...
        if ($current instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Token_Start) {
            $nesting++;
        } elseif ($current instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Token_End) {
            if ($nesting <= 0) {
                return false;
            }
            $nesting--;
     ...
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_Token $token Current token variable.
