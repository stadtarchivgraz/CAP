...
class BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLDefinition extends BracketSpace_Notification_Dependencies_HTMLPurifier_Definition
{
    ...
    /**
     * Associative array of element names to BracketSpace_Notification_Dependencies_HTMLPurifier_ElementDef.
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_ElementDef[]
     */
    public $info = array();
    ...
    /**
     * Indexed list of BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform to be performed before validation.
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform[]
     */
    public $info_attr_transform_pre = array();

    /**
     * Indexed list of BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform to be performed after validation.
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform[]
     */
    ...
    /**
     * Indexed list of BracketSpace_Notification_Dependencies_HTMLPurifier_Injector to be used.
    ...
    /**
     * Doctype object
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_Doctype
     */
    public $doctype;
     ...
     *       method in BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule
     ...
     *             BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTypes for details
     */
     ...
     * @see BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule::addElement() for detailed
     ...
     * @return BracketSpace_Notification_Dependencies_HTMLPurifier_ElementDef
     * @see BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule::addBlankElement() for detailed
     *       parameter and return value descriptions.
     */
     ...
     * module.
     * @return BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule
     */
    public function getAnonymousModule()
    {
        if (!$this->_anonModule) {
            $this->_anonModule = new BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule();
    ...
    /**
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModuleManager
     */
    public $manager;
    ...
    {
        $this->manager = new BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModuleManager();
    }
