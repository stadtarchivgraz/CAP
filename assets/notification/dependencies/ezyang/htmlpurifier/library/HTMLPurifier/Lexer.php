 ...
 * BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer_DOMLex).  There are several implementations to choose
 * from.
 *
...
class BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer
{
    ...
    /**
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_EntityParser
     */
     ...
     *
     * By default BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer_DOMLex will be returned. There are
     ...
     * @return BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer
    ...
    public static function create($config)
    {
        ...
        if (is_object($lexer)) {
            ...
            switch ($lexer) {
                case 'DOMLex':
                    $inst = new BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer_DOMLex();
                    break;
                case 'DirectLex':
                    $inst = new BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer_DirectLex();
                    break;
                case 'PH5P':
                    $inst = new BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer_PH5P();
                    break;
                default:
        ...
        if (!$inst) {
            throw new BracketSpace_Notification_Dependencies_HTMLPurifier_Exception('No lexer was instantiated');
        }
    ...
    {
        $this->_entity_parser = new BracketSpace_Notification_Dependencies_HTMLPurifier_EntityParser();
    }
     ...
     * @return BracketSpace_Notification_Dependencies_HTMLPurifier_Token[] array representation of HTML.
     */
    ...
    protected static function escapeCDATA($string)
    {
        return preg_replace_callback(
            '/<!\[CDATA\[(.+?)\]\]>/s',
            array('BracketSpace_Notification_Dependencies_HTMLPurifier_Lexer', 'CDATACallback'),
            $string
        );
    }
    ...
    public function normalize($html, $config, $context)
    {
        ...
        $html = BracketSpace_Notification_Dependencies_HTMLPurifier_Encoder::cleanUTF8($html);
