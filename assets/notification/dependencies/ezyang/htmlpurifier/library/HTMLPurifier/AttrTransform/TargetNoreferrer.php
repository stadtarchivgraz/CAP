 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform_TargetNoreferrer extends BracketSpace_Notification_Dependencies_HTMLPurifier_AttrTransform
{
    /**
     * @param array $attr
