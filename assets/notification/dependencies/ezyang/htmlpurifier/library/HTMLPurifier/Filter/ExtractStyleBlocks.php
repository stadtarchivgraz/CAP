 ...
 *
 * @note
 *      See tests/BracketSpace_Notification_Dependencies_HTMLPurifier/Filter/ExtractStyleBlocksTest.php for
 *      sample usage.
 *
 * @note
...
class BracketSpace_Notification_Dependencies_HTMLPurifier_Filter_ExtractStyleBlocks extends BracketSpace_Notification_Dependencies_HTMLPurifier_Filter
{
    ...
    /**
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_CSS_Ident
     */
    private $_class_attrdef;

    /**
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_Enum
     */
    ...
    public function __construct()
    {
        ...
        $this->_id_attrdef = new BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_HTML_ID(true);
        $this->_class_attrdef = new BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_CSS_Ident();
        $this->_enum_attrdef = new BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_Enum(
            array(
                'first-child',
                'link',
                'visited',
                                ...
                                for ($j = 0, $cc = count($components); $j < $cc; $j++) {
                                    ...
                                    if ($j === 0) {
                                        ...
                                        if ($sdelim === '#') {
                                            ...
                                            throw new BracketSpace_Notification_Dependencies_HTMLPurifier_Exception('broken invariant sdelim and preg_split');
                                        }
