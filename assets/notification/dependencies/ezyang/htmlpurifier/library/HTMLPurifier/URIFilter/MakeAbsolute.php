...
class BracketSpace_Notification_Dependencies_HTMLPurifier_URIFilter_MakeAbsolute extends BracketSpace_Notification_Dependencies_HTMLPurifier_URIFilter
{
    /**
     * @type string
     *
