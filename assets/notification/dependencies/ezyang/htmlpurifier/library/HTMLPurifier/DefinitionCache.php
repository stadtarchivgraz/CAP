 ...
 */
abstract class BracketSpace_Notification_Dependencies_HTMLPurifier_DefinitionCache
{
    /**
     * @type string
     */
     ...
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_Config $config Instance of BracketSpace_Notification_Dependencies_HTMLPurifier_Config to test against
     * @return bool
     */
     ...
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_Definition $def Definition object to check
