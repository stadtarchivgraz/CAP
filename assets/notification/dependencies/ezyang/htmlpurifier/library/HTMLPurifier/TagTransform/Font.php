 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_TagTransform_Font extends BracketSpace_Notification_Dependencies_HTMLPurifier_TagTransform
{
    /**
     * @type string
     */
     ...
     * @return BracketSpace_Notification_Dependencies_HTMLPurifier_Token_End|string
     */
    public function transform($tag, $config, $context)
    {
        if ($tag instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Token_End) {
            $new_tag = clone $tag;
