 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef_Table extends BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef
{
    /**
     * @type bool
     */
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            if ($node instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Node_Comment) {
                $ws_accum[] = $node;
                continue;
            }
            switch ($node->name) {
            ...
            foreach($content as $node) {
                ...
                case 'tr':
                    if ($current_tr_tbody === null) {
                        $current_tr_tbody = new BracketSpace_Notification_Dependencies_HTMLPurifier_Node_Element('tbody');
