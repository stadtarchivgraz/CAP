 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef_List extends BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef
{
    /**
     * @type string
     */
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            ...
            if ($node->name === 'li') {
                ...
                if ($current_li === null) {
                    $current_li = new BracketSpace_Notification_Dependencies_HTMLPurifier_Node_Element('li');
                    $result[] = $current_li;
                }
