...
class BracketSpace_Notification_Dependencies_HTMLPurifier_Printer_HTMLDefinition extends BracketSpace_Notification_Dependencies_HTMLPurifier_Printer
{

    /**
     * @type BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLDefinition, for easy access
     */
    protected $def;
     ...
     * @param BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef $def BracketSpace_Notification_Dependencies_HTMLPurifier_ChildDef of pertinent element
     * @return string
     */
     ...
     * @param array $array Array hash in form of array('attrname' => BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef)
     * @return string
     */
