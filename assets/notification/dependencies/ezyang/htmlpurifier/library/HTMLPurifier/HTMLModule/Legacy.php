...
class BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule_Legacy extends BracketSpace_Notification_Dependencies_HTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $li->attr['value'] = new BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_Integer();
        $li->attr['type'] = 'Enum#s:1,i,I,a,A,disc,square,circle';

        $ol = $this->addBlankElement('ol');
        $ol->attr['compact'] = 'Bool#compact';
        $ol->attr['start'] = new BracketSpace_Notification_Dependencies_HTMLPurifier_AttrDef_Integer();
