...
class BracketSpace_Notification_Dependencies_HTMLPurifier_Language
{
    ...
    public function load()
    {
        ...
        $factory = BracketSpace_Notification_Dependencies_HTMLPurifier_LanguageFactory::instance();
    ...
    public function formatMessage($key, $args = array())
    {
        ...
        foreach ($args as $i => $value) {
            if (is_object($value)) {
                if ($value instanceof BracketSpace_Notification_Dependencies_HTMLPurifier_Token) {
