 ...
 */
class BracketSpace_Notification_Dependencies_HTMLPurifier_Encoder
{
    ...
    {
        set_error_handler(array('BracketSpace_Notification_Dependencies_HTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
     ...
     * Arguably this function should be modernized to the BracketSpace_Notification_Dependencies_HTML5 set
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        $bug = BracketSpace_Notification_Dependencies_HTMLPurifier_Encoder::testIconvTruncateBug();
