...
use BracketSpace\Notification\Dependencies\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
    ...
    protected function doSave(array $values, int $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\BracketSpace\Notification\Dependencies\Symfony\Component\VarExporter\Internal\\', '', $value);
