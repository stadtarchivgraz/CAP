...
use BracketSpace_Notification_Dependencies_HTMLPurifier as HTMLPurifier;
use BracketSpace_Notification_Dependencies_HTMLPurifier_Config as HTMLPurifier_Config;
